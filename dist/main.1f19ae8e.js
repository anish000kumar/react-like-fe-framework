...
var Component = /*#__PURE__*/function () {
  ...
  _createClass(Component, [{
    ...
    value: function setState(nextState) {
      ...
      (0, _.patch)(this.prevNode, this.currentNode);
    }
  }]);
  return Component;
}();
exports.Component = Component;
},{"./":"framework/index.js"}],"node_modules/snabbdom/build/htmldomapi.js":[function(require,module,exports) {
"use strict";
...
var attrMapper = {
  className: function className(state, classNames) {
    return _objectSpread(_objectSpread({}, state), {}, {
      class: _objectSpread(_objectSpread({}, state.class), classNames.split(" ").reduce(function (acc, className) {
        return _objectSpread(_objectSpread({}, acc), {}, _defineProperty({}, className, true));
      }, {}))
    });
  },
  onClick: function onClick(state, click) {
    return _objectSpread(_objectSpread({}, state), {}, {
      on: _objectSpread(_objectSpread({}, state.on), {}, {
        click: click
      })
    });
  },
...
var mappingAttributes = function mappingAttributes(attrs) {
  return function (acc, key) {
    var nextState = attrMapper[key] ? attrMapper[key](acc, attrs[key]) : _objectSpread(_objectSpread({}, acc), {}, {
      props: _objectSpread(_objectSpread({}, acc.props), {}, _defineProperty({}, key, attrs[key]))
    });
    return nextState;
  };
};
...
exports.createElement = exports.createComponent = void 0;
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var createComponent = function createComponent(Component, attrs, children) {
  var component = new Component(_objectSpread({
    children: children
  }, attrs));
...
var createElement = function createElement(tagName, attrs) {
  ...
  return (0, _snabbdom.h)(tagName, (0, _attributes.computeAttrs)(attrs || {}), children);
};
exports.createElement = createElement;
},{"snabbdom":"node_modules/snabbdom/build/index.js","./attributes":"framework/attributes.js"}],"framework/index.js":[function(require,module,exports) {
...
exports.render = exports.patch = void 0;
var _component = require("./component");
var _element = require("./element");
var _snabbdom = require("snabbdom");
global.h = _element.createElement;
var patch = (0, _snabbdom.init)([_snabbdom.classModule,
// makes it easy to toggle classes
_snabbdom.propsModule,
// for setting properties on DOM elements
_snabbdom.eventListenersModule // attaches event listeners
]);
exports.patch = patch;
var render = function render(RootComponent, rootElement) {
  return patch(rootElement, RootComponent);
};
exports.render = render;
},{"./component":"framework/component.js","./element":"framework/element.js","snabbdom":"node_modules/snabbdom/build/index.js"}],"main.js":[function(require,module,exports) {
"use strict";
...
var Counter = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Counter, [{
    ...
    value: function render() {
      var _this2 = this;
      return h("div", null, "count: ", this.state.count, h("button", {
...
var App = /*#__PURE__*/function (_Component2) {
  ...
  _createClass(App, [{
    key: "render",
    value: function render() {
      return h("div", null, h("div", null, "Hi ", h(Counter, null)), h("div", null, "Hi2 ", h(Counter, null)));
    }
  }]);
  return App;
}(_framework.Component);
(0, _framework.render)(h(App, null), document.getElementById("root"));
},{"./framework":"framework/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
